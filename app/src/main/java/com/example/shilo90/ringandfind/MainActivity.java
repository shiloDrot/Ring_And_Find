    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*cntry.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String TempCountry = CountryList.get(position);

                SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putString("country", TempCountry);
                editor.putInt("countryPos", position);
                editor.commit();

            }
        });*/

        //List<String> list = new ArrayList<String>(I2P.keySet());
